              ...
              <b-card no-body>
                ...
                <b-card-body class="pt-0">
                  <div class="ex-page-content text-center">
                    <img :src="errorImg" alt="0" class="" height="170" />
                    <template v-if="error">
                      <h1 class="my-2">{{ error.statusCode }}</h1>
                      <h5 class="fs-16 text-muted mb-3">{{ error.message }}</h5>
                    </template>
                  </div>
                  <NuxtLink class="btn btn-primary w-100" to="/">
                    Back to Dashboard
