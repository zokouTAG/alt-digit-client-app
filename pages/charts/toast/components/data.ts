...
export const bubbleChartConfig = {
  ...
  options: {
    chart: {
      ...
      format: function (value: any, valueType: any) {
...
export const scatteChartConfig = {
  data: {
    series: [
      {
        name: 'male',
...
export const donutPieChartConfig = {
  data: {
    categories: ['Browser'],
    series: [
      {
  ...
  options: {
    chart: {
      ...
      format: function (value: any, areaType: any) {
...
export const boxplotChartConfig = {
  data: {
